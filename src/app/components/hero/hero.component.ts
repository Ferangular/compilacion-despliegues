          ...
          <div class="terminal">
            ...
            <div class="terminal-body">
              <div class="terminal-line">
                ...
                <span class="command">firebase deploy</span>
              </div>
              <div class="terminal-line">
                <span class="output success">✓ Deploy complete!</span>
              </div>
              <div class="terminal-line">
                <span class="output">Hosting URL: https://curso-hosting.web.app</span>
              </div>
              <div class="terminal-line">
                <span class="prompt">$</span>
...
export class HeroComponent {
  readonly title = input<string>('Firebase Hosting Demo');
  readonly subtitle = input<string>('Despliega tu aplicación Angular en segundos');
  readonly description = input<string>('Aprovecha el poder de Firebase Hosting para despliegues rápidos y automáticos con CI/CD');
